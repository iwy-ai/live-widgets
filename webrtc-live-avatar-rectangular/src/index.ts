...
class LiveAvatarElement extends HTMLElement {
  ...
  private render() {
    ...
    this.videoElement = this.shadow.getElementById('bot-video') as HTMLVideoElement;
    this.audioElement = this.shadow.getElementById('bot-audio') as HTMLAudioElement;
    this.connectBtn = this.shadow.getElementById('connect-btn') as HTMLButtonElement;
    this.muteBtn = this.shadow.getElementById('mute-btn') as HTMLButtonElement;
  }
  ...
  private connectWebSocket(): Promise<void> {
    return new Promise((resolve, reject) => {
      const wsUrl = `wss://iwy-ai--wr-start.modal.run/ws/${this.peerId}`;
