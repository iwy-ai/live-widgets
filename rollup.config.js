...
export default [
  // UMD build for CDN usage (with Pipecat bundled)
  {
    ...
    output: {
      ...
      format: 'iife',
      name: 'LiveAvatar',
      banner: '/* @iwy/live-avatar v1.3.0 | MIT License | https://www.iwy.ai */'
    },
    plugins: [
      resolve({
        browser: true,
  ...
  // Rectangular variant - UMD build for CDN usage (with Pipecat bundled)
  {
    ...
    output: {
      ...
      banner: '/* @iwy/live-avatar-rectangular v1.3.0 | MIT License | https://www.iwy.ai */'
    },
    plugins: [
      resolve({
        browser: true,
  ...
  // Audio Visualizer - UMD build for CDN usage (with Pipecat and Three.js bundled)
  {
    ...
    output: {
      ...
      banner: '/* @iwy/audio-visualizer v1.3.0 | MIT License | https://www.iwy.ai */'
    },
    plugins: [
      resolve({
        browser: true,
